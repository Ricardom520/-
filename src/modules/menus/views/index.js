            ...
            <Fragment>
                <div className='right2' ref={right2=>this.right2=right2}>
                    <ul className="positionLists">
                        ...
                        <li onContextMenu={(e)=>this.onContextMenu(e)} id="myFiles" onClick={(e)=>this.ContextRight2Click(e,'myfile')}>
                ...
                <div className="content">
                    <Route>
                        <Switch>
                            <Route path="/explorer/files/position" component={Files}/>
                            <Route path="/explorer/files/favorite" component={Files}/>
                            <Route path="/explorer/files/myfile" component={Files}/>
                            <Route path="/explorer/files/tool" component={Files}/>
                            <Route path="/explorer/files/nearfile" component={Files}/>
                            <Route path="/explorer/files/myshare" component={Files}/>
                            <Route path="/explorer/files/dustbin" component={Files}/>
                            <Route path="/explorer/files/filetype" component={Files}/>
                            <Route path="/explorer/files/file" component={Files}/>
                            <Route path="/explorer/files/photo" component={Files}/>
                            <Route path="/explorer/files/music" component={Files}/>
                            <Route path="/explorer/files/video" component={Files}/>
                            <Route path="/explorer/files/others" component={Files}/>
                            <Route path="/explorer/files/package" component={Files}/>
